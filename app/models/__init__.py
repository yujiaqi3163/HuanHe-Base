...
# 导出模型，方便其他模块使用
__all__ = ['User', 'RegisterSecret', 'TerminalSecret', 'MaterialType', 'Material', 'MaterialImage', 'UserMaterial', 'UserMaterialImage', 'Config', 'Permission', 'UserPermission', 'init_permissions']
